...
<?php
	...
	$sql="SELECT * FROM booked where booked.email='". $ids2[0]. "'";
...
?>
  ...
  <form method='GET' >
	  ...
	  <input type='submit' align="right" id="but4" name='logout'  Value='Logout'>
	  </form>
  <?php
    include('ccc.php'); 
	$ct=$_COOKIE['email'];
...
$rqu2= "DELETE FROM booked WHERE booked.id = '$jo'";
